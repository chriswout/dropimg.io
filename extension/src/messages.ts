...
const en: MessageMap = {
  ...
  extDescription:
    "Capture the current tab, get a temporary shareable link. No account. Expires in 24 hours.",
  ...
  expiresInHours: "in about $1$h",
  expiresInMins: "in $1$m",
  remainingHm: "$1$h $2$m",
...
const es: MessageMap = {
  ...
  extDescription:
    "Captura la pestaña visible y obtén un enlace temporal. Sin cuenta. Caduca en 24 horas.",
  ...
  expiresInHours: "en unas $1$h",
  expiresInMins: "en $1$m",
  remainingHm: "$1$h $2$m",
...
const pt_BR: MessageMap = {
  ...
  extDescription:
    "Capture a aba visível e ganhe um link temporário. Sem conta. Expira em 24 horas.",
  ...
  expiresInHours: "em cerca de $1$h",
  expiresInMins: "em $1$m",
  remainingHm: "$1$h $2$m",
...
const de: MessageMap = {
  ...
  extDescription:
    "Sichtbaren Tab erfassen, temporären Link bekommen. Kein Konto. Läuft nach 24 Stunden ab.",
  actionTitle: "Screenshot → dropimg.io-Link",
