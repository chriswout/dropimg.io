...
export const HOME: Record<Locale, HomeCopy> = {
  en: {
    ...
    securityFacts: [
      ...
      "Immutable versions behind a stable alias",
      "No executables or source files",
    ],
    securityPublic:
  ...
  es: {
    ...
    securityFacts: [
      ...
      "Versiones inmutables detrás de un alias estable",
  ...
  "pt-BR": {
    ...
    securityFacts: [
      ...
      "Versões imutáveis atrás de um alias estável",
  ...
  de: {
    ...
    securityFacts: [
      ...
      "Unveränderliche Versionen hinter einem stabilen Alias",
      "Keine Executables oder Quelldateien",
    ],
    securityPublic:
