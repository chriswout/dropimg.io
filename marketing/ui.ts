...
const en: UiStrings = {
  ...
  dropHintFormats: "PNG, JPEG, WebP, GIF · max 25\u00a0MB",
  ...
  needLongerBody: "Keep links up to 180 days with Drops Pro — €2.99/month.",
  proControlsKicker: "DROPS PRO",
  ...
  errors: {
    too_large: "File exceeds the 25 MB limit.",
...
const es: UiStrings = {
  ...
  dropHintFormats: "PNG, JPEG, WebP, GIF · máx. 25\u00a0MB",
  ...
  tooLarge: "El archivo supera los 25 MB.",
  tooLargeLimit: (mb) => `El archivo supera los ${mb} MB.`,
  passwordTooShort: "La contraseña debe tener al menos 8 caracteres.",
  passwordProtected: "Protegido con contraseña",
  manageInDrops: "Gestionar en Mis Drops",
  needLongerTitle: "¿Lo necesitas más tiempo?",
  needLongerBody: "Conserva enlaces hasta 180 días con Drops Pro — €2.99/mes.",
  proControlsKicker: "DROPS PRO",
  expiresLabel: "Caduca",
  expiry1h: "1 hora",
  expiry24h: "24 horas",
  ...
  errors: {
    too_large: "El archivo supera los 25 MB.",
...
const ptBR: UiStrings = {
  ...
  tooLarge: "O arquivo passa de 25 MB.",
  ...
  manageInDrops: "Gerenciar em Meus Drops",
  needLongerTitle: "Precisa por mais tempo?",
  needLongerBody: "Mantenha links por até 180 dias com Drops Pro — €2.99/mês.",
  proControlsKicker: "DROPS PRO",
  expiresLabel: "Expira",
  expiry1h: "1 hora",
  expiry24h: "24 horas",
  ...
  errors: {
    too_large: "O arquivo passa de 25 MB.",
...
const de: UiStrings = {
  ...
  tooLarge: "Datei ist größer als 25 MB.",
  ...
  needLongerBody: "Links bis 180 Tage mit Drops Pro — €2.99/Monat.",
  proControlsKicker: "DROPS PRO",
  ...
  errors: {
    too_large: "Datei ist größer als 25 MB.",
